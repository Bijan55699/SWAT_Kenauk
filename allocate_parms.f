...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
      ...
      !!BEGIN GEVENSON GIW PARAMETERS
      allocate (giw_flag(mhru))
      allocate (giw_type(mhru))
      allocate (drain_to(mhru))
      allocate (giw_precip_in_mm(mhru))
      allocate (giw_spillage_out_mm(mhru))
      allocate (giw_seepage_out_mm(mhru))
      allocate (giw_flwin_mm(mhru))
      allocate (giw_flwin_qday_mm(mhru))
      allocate (giw_flwin_latq_mm(mhru))
      allocate (giw_flwin_gwq_mm(mhru))
      allocate (giw_flwin_deepgw_mm(mhru))
      allocate (giw_vol_mm(mhru))
      allocate (giw_volx_mm(mhru))
      allocate (giw_k(mhru))
      allocate (giw_sa_m2(mhru))
      allocate (giw_vol_prev_mm(mhru))
      !!END GEVENSON GIW PARAMETERS
      
      !! BEGIN MOHAMMAD RAF
      allocate (RAF_flag(mhru))
      allocate (Z_RAF(mhru))
      allocate (Z_SW(mhru))
      allocate (QinRAF(mhru))
      allocate (QoutRAF(mhru))
      allocate (RAF_vol_m3(mhru))
      allocate (RAF_vol_mm(mhru))
      allocate (RAF_area_m2(mhru))
      allocate (VoloutRAF_prev(mhru))
      !! END MOHAMMAD
      allocate (lat_giw(mhru))
      allocate (lon_giw(mhru))
      allocate (OID_giw(mhru))
      allocate (giw_typo(mhru))
      allocate (SAHAGIW(mhru))
      allocate (Pet_GIW(mhru))
