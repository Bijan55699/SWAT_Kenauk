...
!!    real, parameter :: esd = 500., etco = 0.80, effnup = 0.1
      ...
      !giw_sa_m2(j) = giw_vol_m3/0.96535
                giw_sa_ha = giw_sa_m2(j)*0.0001
                !giw_sa_ha = sam2/10000.  ! surface area in ha
                !giw_evap_out_m3 = 10. * 0.6 * pet * giw_sa_ha !TAKEN FROM CONV WETLAND
                giw_evap_out_m3 = 10. * 0.6 * cevapgiw * pet *giw_sa_ha !Mohammad
                
                  !if (j==55) then
                  !    giw_evap_out_mm = (giw_evap_out_m3 *1000.)/34.85
                  !else
                  !    giw_evap_out_mm = (giw_evap_out_m3 *1000.)/192.28
                  !end if
                
                giw_evap_out_mm = (giw_evap_out_m3 *1000.)/192.28
                
                !giw_evap_out_mm = (giw_evap_out_m3/hru_area_m2)*1000.
