      ...
      !!BEGIN GEVENSON
      real, dimension (:), allocatable :: giw_precip_in_mm
      real, dimension (:), allocatable :: giw_spillage_out_mm
      real, dimension (:), allocatable :: giw_seepage_out_mm
      real, dimension (:), allocatable :: giw_flwin_mm, giw_vol_mm
      real, dimension (:), allocatable :: giw_volx_mm, giw_sa_m2
      real, dimension (:), allocatable :: giw_k
      real, dimension (:), allocatable :: giw_flwin_qday_mm
      real, dimension (:), allocatable :: giw_flwin_latq_mm
      real, dimension (:), allocatable :: giw_flwin_gwq_mm
      real, dimension (:), allocatable :: giw_flwin_deepgw_mm
      integer, dimension (:), allocatable :: drain_to, giw_type
      integer, dimension (:), allocatable :: giw_flag
      integer, dimension (:), allocatable :: OID_giw, giw_typo  !Mohammad
      real, dimension (:), allocatable :: giw_vol_prev_mm
      real, dimension (:), allocatable :: lat_giw, lon_giw,SAHAGIW   !Mohammad
      real :: giw_vol_mm_begin, giw_flwin_share_mm, giw_evap_out_mm
      real :: record_giw_seepage_in_mm, canstor_prev, cevapgiw, cbedgiw
      !!END GEVENSON
      
      !! Begin RAF Mohammad
      integer, dimension (:), allocatable :: RAF_flag
      real, dimension (:), allocatable :: Z_RAF,Z_SW
      real, dimension (:), allocatable :: RAF_vol_m3, RAF_vol_mm 
      real, dimension (:), allocatable :: RAF_area_m2
      real, dimension (:), allocatable :: QinRAF, QoutRAF
      real, dimension (:), allocatable :: VoloutRAF_prev,Pet_GIW ! Mohammad
      !! End RAF Mohammad
